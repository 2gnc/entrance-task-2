...
* Версия для мобильных: 
    ...
    2. Тултип с информацией о встрече будет позиционироваться динамически через JS.В верстке приведен 
    пример, а в приложении координаты будут рассчитываться каждый раз при клике на занятый слот.
