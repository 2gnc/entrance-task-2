...
/temp                  временные неминифицированные файлы для отладки и третьего задания
</pre>
...
```
Пожалуйста убедитесь, что зависимости установились. После запуска верстку можно посмотреть на localhost, описание и пути к файлам смотрите выше.